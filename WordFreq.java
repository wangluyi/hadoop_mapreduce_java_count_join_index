...
public class WordFreq {
	...
	public static class CountMapper extends Mapper<Object, Text, Text, IntWritable> {
		...
		public void map(Object key, Text value, Context context)
			...
			while (tokenizer.hasMoreTokens()) {
				...
				// the first mapreduce job create <keyword, count> pairs
			}
		}
	}
	...
	public static class CountReducer extends Reducer<Text, IntWritable, Text, IntWritable> {
		...
		context.write(key, new IntWritable(sum)); // create pair <keyword, count>
		}
	}
	...
	public static class TopKMapper extends Mapper<Object, Text, NullWritable, Text> {
		...
		// use the treemap to store the <WordCount,word> pair, default order by key is ascending 
	...
	public static void main(String[] args) throws Exception {
		...
		Job job = Job.getInstance(conf, "WordFreq job1");
		...
		Path outputDestination = new Path(args[0]+"first");  // temp file for first job
		...
		// Create job2
		Job job2 = Job.getInstance(conf, "WordFreq job2");
